...
void NewLab10Q1App::Init()
{
	...
	// model matrix - head cube
	cubes[1]->SetTranslate(glm::vec3(0, 1.4, 0));
	cubes[1]->SetScale(glm::vec3(0.5, 0.5, 0.5));
	cubes[1]->setColor(glm::vec4(0.0, 0.0, 1.0, 1.0));

	// model matrix - left arm
	cubes[2]->SetTranslate(glm::vec3(1.4, 0.6, 0));
	cubes[2]->SetScale(glm::vec3(0.6, 0.3, 0.3));
	cubes[2]->setColor(glm::vec4(0.0, 1.0, 0.0, 1.0));

	// model matrix - right arm
	cubes[3]->SetTranslate(glm::vec3(-1.4, 0.6, 0));
	cubes[3]->SetScale(glm::vec3(0.6, 0.3, 0.3));
	cubes[3]->setColor(glm::vec4(0.0, 1.0, 0.0, 1.0));
...
void NewLab10Q1App::Draw()
{
	...
	cubes[4]->SetTranslate(glm::vec3(0, +legmove, 0));
	cubes[5]->SetTranslate(glm::vec3(0, -legmove, 0));
